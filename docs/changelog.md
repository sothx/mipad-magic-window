...
-  模块设置新增"Shamiko工作模式"的黑白名单切换功能

-  模块设置新增"第三方触控笔管理（水龙移植包）"的配置，仅水龙的小米平板移植包显示该配置项

-  模块设置新增"手写笔驱动管理（水龙移植包）"的配置，仅水龙的小米平板移植包显示该配置项

-  模块设置新增"键盘连接器管理（水龙移植包）"的配置，仅水龙的小米平板移植包显示该配置项
