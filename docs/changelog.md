...
- 新增DNA-Android(com.dna.tools)的适配优化
- 移除哔哩哔哩HD的竖屏优化(存在重启后关闭按钮失效的BUG)，如果需要哔哩哔哩HD的竖屏优化，请参考[自定义规则](https://hyper-magic-window.sothx.com/custom-config.html)强制哔哩哔哩HD在竖屏时也显示。
