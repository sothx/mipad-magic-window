...
const buildVerifyFunctionsExtendsType = function () {
    ...
    if (['general-tiramisu','general-upsideDownCake','hyperos-based-on-tiramisu','hyperos1-based-on-upsideDownCake','yudi-device-code','sheng-device-code','pipa-device-code','miui-based-on-tiramisu','dagu-device-code'].includes(options.use_compatibility)) {
