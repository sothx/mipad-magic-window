...
module.exports = function buildApplicationCount(cb) {
  return src(options.use_mode === 'activityEmbedding' ? ['temp/embedded_rules_list.xml','temp/fixed_orientation_list.xml','temp/autoui_list.xml'] : 'temp/magicWindowFeature_magic_window_application_list.xml') // 指定XML文件的路径
    .pipe(gulpXML({
