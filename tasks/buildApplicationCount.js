...
module.exports = function buildApplicationCount(cb) {
  return src(options.use_mode === 'activityEmbedding' ? (options.use_platform === 'phone' ? ['temp/embedded_rules_list_projection.xml','temp/fixed_orientation_list_projection.xml','temp/generic_rules_list_projection.xml'] : ['temp/embedded_rules_list.xml','temp/fixed_orientation_list.xml','temp/autoui_list.xml']) : 'temp/magicWindowFeature_magic_window_application_list.xml') // 指定XML文件的路径
    .pipe(gulpXML({
