...
let knownOptions = {
  ...
  default: {
    ...
    use_compatibility: '', // 特别版本的兼容参数，not-dragable——不支持左右滑动条的机型,hyperos-based-on-tiramisu——基于Android 13的 Hyper OS,transplant-6max-based-on-tiramisu——基于Android 13的 6 Max移植包
