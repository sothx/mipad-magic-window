import{d,h as c,ay as m,az as p,aA as u,aB as g,aC as f,aD as y,i as o,j as b,S as _,aE as x,aF as k,r as s,k as S,g as t,n,l as v,m as h,b as M,e as P,f as D,s as O,v as B,x as w,aG as A}from"./index-aIMEIzF0.js";const C={class:"setting"},T={class:"mt-3"},N={class:"px-3 sm:px-0"},V={class:"mt-3"},F=d({__name:"ToolsView",setup(E){const a=c();m(),p(),u(),g(),f(),y();const r=o(()=>({theme:a.isDarkMode?B:w}));b(["message","modal"],{configProviderProps:r}),_(),x(),k();const i=s([{label:"MiSans",key:"MiSans",type:"info"},{label:"HarmonyOS Sans",key:"HarmonyOS Sans",type:"error"},{label:"OPPO Sans",key:"OPPO Sans",type:"success"}]);return o(()=>A(i.value,"key")),s(""),s(!1),(R,e)=>{const l=P("n-alert");return D(),S("div",C,[t("div",T,[t("div",N,[e[0]||(e[0]=t("h3",{class:n("text-base font-semibold leading-7")},[t("span",{class:"animated-bg bg-clip-text font-semibold text-transparent",style:{"background-image":`linear-gradient(\r
							...
							)`}},"百宝箱")],-1)),t("p",{class:n(`mt-1 max-w-2xl text-sm leading-6 ${v(a).isDarkMode?"text-gray-300":"text-gray-500"}`)}," 百宝箱，汇集了丰富的实用工具 ",2)]),t("div",V,[h(l,{title:"极暗模式",class:"cursor-pointer","show-icon":!1,type:"info"},{default:M(()=>e[1]||(e[1]=[O("点击可以快速打开支付宝的扫码界面")])),_:1})])])])}}});export{F as default};
